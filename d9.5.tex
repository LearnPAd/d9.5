...
%%% ---------------- The Title
%%% ------------------------------------------------------
\title{Technology-oriented \learnpad whitepaper}
...
\reviewinternal{10 Jan. 2016}{2.5}{Andrea Polini, Antonia Bertolino}{}
...
\begin{history}
  ...
  \historyitem{2.5}{Improve with contributions from NME, FHNW}{Jovaldas Januškevičius, Andrea Polini, Andrea Sergiacomi, Barbara Thönssen}
\end{history}
